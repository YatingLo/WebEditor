...
var imageRepository = new function() {
	...
	this.spaceship.src = "imgs/player.png";
	this.bullet.src = "imgs/bullet.png";
	this.enemy.src = "imgs/enemy.png";
	this.enemyBullet.src = "imgs/fruit1.png";
}
...
function Background() {
	...
	this.draw = function() {
		this.context.drawImage(imageRepository.background, this.x-130, this.y);
	};
}
...
function Game() {
	...
	this.init = function() {
		...
		if (this.bgCanvas.getContext) {
			...
			var shipStartY = this.shipCanvas.height/4 + imageRepository.spaceship.height*1.5;
			...
			var width = imageRepository.enemy.width +50;
...
function runTime() {
	if(game.playTime > 0){
		game.playTime -= 1;
		document.getElementById('downtime').innerHTML = game.playTime;
		setTimeout("runTime()", 1000);
