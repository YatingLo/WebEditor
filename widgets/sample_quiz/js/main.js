...
var fun_checkAns = function() {
	...
	$('#quiz_result div').html(
			//str_ans + 
			"<br/>分數:<span id='quiz_score'>" + int_score + '</span>');
};
//再一次
...
var fun_sendResult = function() {
	...
	$.ajax({
        type: 'POST', 
        url: 'http://www.ytl-pc.com/widget/editor/handle-upload.php', 
        crossDomain: true,
        dataType: 'json',
        data: 'action=send&id=' + json_send.id + '&data=' + json_send.data,
