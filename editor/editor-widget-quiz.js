...
$(document).ready(function() {
	...
	$('#tabs').tabs();
	$('#saveHtml').click(saveDocument(Editor.widgetId));
	//在入檔案
	/*
	$('#contentL').load("www.ytl-pc.com/mywidget/widgets/" + Editor.widgetId + ".wdgt/index.html", function() {
